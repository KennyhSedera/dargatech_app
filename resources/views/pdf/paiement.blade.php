    ...
    <div class="container">
                ...
                <div class="logo-inner">
                    <div>
                        <div>
                            ...
                            <img src="{{ asset('images/togo.png') }}" alt="Togo Flag" style="height: 15px;">
                        </div>
                        <img src="{{ asset('images/titre.png') }}" alt="logo" style="height: auto; width: 152px;">
                    </div>
        ...
        <div class="clearfix info-sections">
            ...
            <div class="info-section info-section-right">
                ...
                <div class="info-content">
                    <strong>{{ $data['civilite_acheteur'] }} {{ $data['nom_acheteur'] }} {{ $data['prenom_acheteur']
                        }}</strong><br>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right" style="font-weight: bold;">{{ number_format($data['total_ht'], 0, ',', '
                            ') }}</td>
                        <td></td>
                        <td class="text-right" style="font-weight: bold;">{{ number_format($data['total_tva'], 0, ',', '
                            ') }}</td>
                        <td class="text-right" style="font-weight: bold;">{{ number_format($data['total_ttc'], 0, ',', '
                            ') }}</td>
                    </tr>
                </tbody>
            </table>
