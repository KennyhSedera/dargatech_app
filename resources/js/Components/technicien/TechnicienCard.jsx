            ...
            <div className="">
                <div className="flex items-center px-6 py-5 mb-4 bg-gradient-to-br dark:from-blue-500 dark:to-purple-500 from-red-500 to-orange-500">
                    ...
                    <div className="flex-grow">
                        <h3 className="mb-1 text-xl font-bold text-gray-100">{technician.name}</h3>
                        <p className="font-medium text-gray-200">{technician.speciality}</p>
                    </div>
                </div>
                ...
                <div className="px-6 pt-2 pb-5 space-y-3">
                    <div className="flex items-center px-3 py-2 bg-gray-100 rounded-lg dark:bg-gray-700">
                        ...
                        <span className="text-sm font-medium text-gray-700 truncate dark:text-gray-300" title={technician.email}>
                            {technician.email}
                        </span>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div className="flex items-center px-3 py-2 bg-gray-100 rounded-lg dark:bg-gray-700">
                            ...
                            <span className="text-sm text-gray-700 dark:text-gray-300">{technician.genre}</span>
                        </div>

                        <div className="flex items-center px-3 py-2 bg-gray-100 rounded-lg dark:bg-gray-700">
                            {/* <FaPhone className="mr-2 text-lg text-gray-500 dark:text-gray-400" /> */}
                            <span className="text-sm text-gray-700 truncate dark:text-gray-300">{technician.contact}</span>
                        </div>
                    </div>

                    <div className="flex items-center px-3 py-2 bg-gray-100 rounded-lg dark:bg-gray-700">
                        <FaMapMarkerAlt className="mr-3 text-gray-500 dark:text-gray-400" />
                        <span className="text-sm text-gray-700 dark:text-gray-300">{technician.adress}</span>
                    </div>
                </div>
            </div>
        </div>
