    ...
    useEffect(() => {
        ...
        if (dataModify.id) {
            setData({
                ...
                date_intervention: formatDate(dataModify.date_intervention) || new Date().toISOString().split('T')[0],
    ...
    return (
        <Modal show={open} closeable={false} onClose={onClose} maxWidth='xl'>
            ...
            <form className='grid w-full grid-cols-1 gap-4 my-6 sm:grid-cols-2'>
                ...
                <div>
                    <InputLabel htmlFor="type_intervention" value="Type d'intervention" />
                    <SelectInput
                ...
                <div>
                    <InputLabel htmlFor="solutions_apportees" value="Solutions apportées" />
                    <TextInput
                        id="solutions_apportees"
                        name="solutions_apportees"
                        value={data.solutions_apportees}
                        className="block w-full mt-1"
                ...
                <div>
                    <InputLabel htmlFor="duree_intervention" value="Durée de l'intervention (jour)" />
                    <TextInput
                        id="duree_intervention"
                        name="duree_intervention"
                        value={data.duree_intervention}
                        className="block w-full mt-1"
                        autoComplete="duree_intervention"
