            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-5">
                    <div className="lg:col-span-1">
                        ...
                        <SelectInput
                            ...
                            onChange={(e) =>
                                setData("civilite_acheteur", e.target.value)
                            }
                            required
                        >
                    ...
                    <div className="sm:col-span-1 lg:col-span-2">
                        ...
                        <InputError
                            message={
                                validationErrors.prenom_acheteur ||
                                errors.prenom_acheteur
                            }
                            className="mt-2"
                        />
                    </div>
                    ...
                    <div className="sm:col-span-1 lg:col-span-2">
                        ...
                        <TextInput
                            ...
                            onChange={(e) =>
                                setData("nom_acheteur", e.target.value)
                            }
                            required
                            onFocus={() =>
                                setValidationErrors({
                ...
                <div>
                    ...
                    <TextInput
                        ...
                        onChange={(e) =>
                            setData("num_rue_acheteur", e.target.value)
                        }
                        required
                        onFocus={() =>
                            setValidationErrors({
                    ...
                    <InputError
                        message={
                            validationErrors.num_rue_acheteur ||
                            errors.num_rue_acheteur
                        }
                        className="mt-2"
                    />
                </div>
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    <div>
                        ...
                        <TextInput
                            ...
                            onChange={(e) =>
                                setData("ville_acheteur", e.target.value)
                            }
                            required
                            onFocus={() =>
                                setValidationErrors({
                        ...
                        <InputError
                            message={
                                validationErrors.ville_acheteur ||
                                errors.ville_acheteur
                            }
                            className="mt-2"
                        />
                    </div>
                    <div>
                        ...
                        <TextInput
                            ...
                            onChange={(e) =>
                                setData("pays_acheteur", e.target.value)
                            }
                            required
                            onFocus={() =>
                                setValidationErrors({
                        ...
                        <InputError
                            message={
                                validationErrors.pays_acheteur ||
                                errors.pays_acheteur
                            }
                            className="mt-2"
                        />
                    </div>
