    ...
    return (
        <div className='grid grid-cols-6 gap-2 mt-4'>
            <div>
                ...
                <InputError message={validationErrors.type || errors.type} className="mt-2" />
            </div>
            <div>
                ...
                <TextInput
                    ...
                    required
                    disabled
                    onFocus={() => setValidationErrors({ ...validationErrors, 'numero': '' })}
                />
                <InputError message={validationErrors.numero || errors.numero} className="mt-2" />
            </div>
            <div>
                <InputLabel htmlFor="installation_id" value="Date de création" />
                <TextInput
                    id="date_creation"
                    name="date_creation"
                    ...
                    type='date'
                    required
                    onFocus={() => setValidationErrors({ ...validationErrors, 'date_creation': '' })}
                />
                <InputError message={validationErrors.date_creation || errors.date_creation} className="mt-2" />
            </div>
            <div>
                ...
                <TextInput
                    ...
                    required
                    onFocus={() => setValidationErrors({ ...validationErrors, 'lieu_creation': '' })}
                />
                <InputError message={validationErrors.lieu_creation || errors.lieu_creation} className="mt-2" />
            </div>
            <div>
                <InputLabel htmlFor="date_additionnel" value="Type d'intervention" />
                <SelectInput
                    id="date_additionnel"
            ...
            <div>
                ...
                <TextInput
                    ...
                    required
                    type='date'
                    onFocus={() => setValidationErrors({ ...validationErrors, 'date': '' })}
                />
            </div>
        </div>
    )
