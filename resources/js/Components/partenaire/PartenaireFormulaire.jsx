        ...
        <Modal show={open} closeable={false} onClose={onClose} maxWidth="xl">
            ...
            <form className="grid w-full grid-cols-1 gap-4 my-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    />
                    <InputError
                        message={validationErrors.adresse || errors.adresse}
                        className="mt-2"
                    />
                </div>
                <div>
                ...
                <div>
                    ...
                    />
                    <InputError
                        message={validationErrors.site_web || errors.site_web}
                        className="mt-2"
                    />
                </div>
                <div>
                    ...
                    <InputError
                        message={validationErrors.categorie || errors.categorie}
                        className="mt-2"
                    />
                </div>
                <div>
                ...
                <div>
                    ...
                    />
                    <InputError
                        message={validationErrors.logo || errors.logo}
                        className="mt-2"
                    />
                </div>
            </form>
            <div className="text-right">
                <button
                    type="button"
                    className="w-auto px-4 py-1 mr-2 text-red-600 rounded-md bg-red-400/20 disabled:cursor-not-allowed"
                    onClick={() => onClose("")}
                >
                    Annuler
                </button>
                <button
                    type="button"
                    disabled={load}
                    className="w-auto px-4 py-1 text-white bg-blue-500 rounded-md disabled:cursor-not-allowed disabled:opacity-10"
                    onClick={handleSubmit}
                >
                    {load ? "Chargement..." : btnname}
                </button>
            </div>
        </Modal>
    );
