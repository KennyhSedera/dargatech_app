...
<body>
  <div class="container">
    <div class="header">
      ...
      <p style="font-style: italic; margin-top: 8px; font-size: 14px;">« Avec le soleil, récolter des revenus »</p>
    </div>
    ...
    <div class="content">
      ...
      <p>Nous vous accordons un accès privilégié à la plateforme SISAM avec les droits d'administration complets. En tant qu'administrateur système, vous disposez de l'ensemble des fonctionnalités et des permissions nécessaires à la gestion globale de la plateforme.</p>
      ...
      <p>La documentation technique complète de l'administration système est disponible dans la section "Documentation" de votre tableau de bord.</p>
      
      <div class="security-note">
        <p><strong>Important :</strong> Nous vous rappelons l'importance de respecter les procédures de sécurité lors de vos opérations d'administration.</p>
      </div>
      
      <p>Pour toute assistance ou question relative à l'administration de la plateforme, vous pouvez contacter directement notre équipe de développement.</p>
    ...
    <div class="footer">
      ...
      <p>Cet e-mail contient des informations confidentielles destinées uniquement aux administrateurs système.</p>
    </div>
  </div>
</body>
</html><?php /**PATH E:\dargatech_app\resources\views/emails/admin_email.blade.php ENDPATH**/ ?>