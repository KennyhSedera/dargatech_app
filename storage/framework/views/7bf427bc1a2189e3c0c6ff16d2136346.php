...
<body>
    <div class="email-container">
        ...
        <div style="text-align: center;">
            <a href="<?php echo e(url('reset-password/' . $token . '?email=' . $email)); ?>" class="btn">Réinitialiser mon mot de
                passe</a>
        </div>
        ...
        <div class="footer">
            ...
            <p style="font-size: 11px; color: #888;">Adresse IP de la demande : <?php echo e(request()->ip()); ?> | Date et heure :
                <?php echo e(now()->format('d/m/Y à H:i')); ?></p>
        </div>
    </div>
</body>
