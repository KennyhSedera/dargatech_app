...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Cher partenaire technique <?php echo e($name); ?>,</p>
      
      <p>Nous avons le plaisir de vous donner accès à la plateforme de supervision SISAM, conçue pour optimiser le suivi et la gestion des installations de pompage solaire déployées dans le cadre de notre collaboration.</p>
      ...
      <div class="features-list">
        <p>En tant que partenaire technique et maître d'œuvre, vous bénéficiez d'une interface de gestion avancée vous permettant de :</p>
        <ul>
      ...
      <p>Cette plateforme facilitera la coordination entre les équipes DARGATECH et vos services techniques, assurant ainsi une mise en œuvre optimale du projet et une maintenance efficace des équipements.</p>
      
      <p>Nous restons à votre entière disposition pour toute assistance technique ou formation complémentaire sur l'utilisation de cet outil.</p>
...
</html><?php /**PATH D:\ENI\Stage\dargatech_app\resources\views/emails/partenaire_email.blade.php ENDPATH**/ ?>