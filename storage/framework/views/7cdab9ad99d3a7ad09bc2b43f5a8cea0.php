...
<body>
    ...
    <div class="container">
        <div class="content">
            ...
            <p>Bienvenue sur votre espace de gestion locative. Veuillez trouver ci-dessous votre reçu de paiement pour
                le versement du loyer de la période du <?php echo e($pdfData['periode_couverte']); ?>.</p>
