...
Route::group(['prefix' => 'api'], function () {
    ...
    Route::group(['prefix' => 'materiel', 'as' => 'materiel.',], function () {
    ...
    Route::group(['prefix' => 'paiement', 'as' => 'paiement.',], function () {
    ...
    Route::group(['prefix' => 'type_paiement', 'as' => 'type_paiement.',], function () {
    ...
    Route::group(['prefix' => 'user_role', 'as' => 'user_role.',], function () {
    ...
    Route::group(['prefix' => 'technicien', 'as' => 'technicien.',], function () {
    ...
    Route::group(['prefix' => 'dashboard', 'as' => 'dasboard.',], function () {
