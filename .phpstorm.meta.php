...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\dargatech_app\public\storage' => 'string',
...
'database.redis.cache.database','dompdf.show_warnings','dompdf.public_path','dompdf.convert_entities','dompdf.options.font_dir',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\dargatech_app\\public\\storage',
...
'services.slack.notifications.channel','services.telegram.bot_token','session.driver','session.lifetime','session.expire_on_close',
...
'session.http_only','session.same_site','session.partitioned','telegram.bots.mybot.token','telegram.bots.mybot.certificate_path',
...
'telegram.shared_commands','broadcasting.default','broadcasting.connections.reverb.driver','broadcasting.connections.reverb.key','broadcasting.connections.reverb.secret',
...
'inertia.history.encrypt','tinker.commands','tinker.alias','tinker.dont_alias',);
...
'profile.destroy','profile.photo.update','clients','clients.detail','pompes',
'installations','paiements','form_paiement','interventions','parametres',
'telegram','technicien','alert','rapport','rapport.show',
'affiche','users','partenaires','register',
'login','password.request','password.email','password.reset',
'password.store','verification.notice','verification.verify','verification.send','password.confirm','password.update','logout','admin.store',
'clients.index','clients.getclientinstallation','clients.show','clients.store','clients.update',
'clients.destroy','maintenance.index','maintenance.show','maintenance.store','maintenance.update',
'maintenance.destroy','rapport-maintenances.store','alert.index','alert.show','alert.store',
'alert.update','alert.destroy','installation.index','installation.getInstallation','installation.show',
'installation.store','installation.update','installation.destroy','localisation.index','localisation.show',
'localisation.store','localisation.update','localisation.destroy','materiel.index','materiel.show',
'materiel.store','materiel.update','materiel.destroy','paiement.index','paiement.show',
'paiement.findLastPaiement','paiement.store','paiement.update','paiement.destroy','rapport.index',
'rapport.store','rapport.update','rapport.destroy','type_paiement.index','type_paiement.show',
'type_paiement.store','type_paiement.update','type_paiement.destroy','user_role.index','user_role.show',
'user_role.store','user_role.update','user_role.destroy','technicien.index','technicien.show',
'technicien.store','technicien.update','technicien.destroy','dasboard.count',
'users.index','users.destroy','partenaire.index','partenaire.store',
'partenaire.show','partenaire.update','partenaire.destroy','storage.local',);
        registerArgumentsSet('views', 
'app','emails.admin_email','emails.bot_credentials','emails.paiement_pdf','emails.partenaire_email',
'emails.reset-password','notifications::email','pdf.paiement','vendor.notifications.email','laravel-exceptions-renderer::components.card',
...
'validation.uuid','validation.custom.attribute-name.rule-name','fr.0',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_TIMEZONE',
'APP_URL','FILESYSTEM_DISK','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE',
...
'SESSION_ENCRYPT','SESSION_PATH','SESSION_DOMAIN','BROADCAST_CONNECTION','QUEUE_CONNECTION',
